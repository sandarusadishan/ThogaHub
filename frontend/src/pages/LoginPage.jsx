...
// For this example, we'll use a simple inline SVG.
// You could also use a library like 'react-icons' or 'react-feather'
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm bg-white bg-opacity-90 backdrop-blur-sm p-8 rounded-md shadow-lg transition-all duration-500 transform scale-95 animate-fade-in-up">
        ...
        <p className="mt-4 text-center text-gray-700">
          ...
          <Link
            to="/register"
            className="text-black font-semibold hover:underline transition-colors duration-300"
          >
            Register
          </Link>
        </p>
